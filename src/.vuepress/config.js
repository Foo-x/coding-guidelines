    ...
    sidebar: [
      ...
      },
      {
        ...
        children: [
          ...
          ["/architecture/hiding-information", "5.14. 情報の隠蔽"],
          ["/architecture/minimize-fields", "5.15. フィールド数の最少化"],
          ["/architecture/one-function-one-task", "5.16. 1関数1タスク"],
          ["/architecture/clean-architecture", "5.17. Clean Architecture"],
        ],
      },
      {
        title: "6. テスト",
